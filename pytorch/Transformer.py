...
predict = torch.FloatTensor([[0, 0.2, 0.7, 0.1, 0],
                             [0, 0.2, 0.7, 0.1, 0],
                             [0, 0.2, 0.7, 0.1, 0]])
v = crit(predict.log().clone(), torch.LongTensor([2, 1, 0])).clone().detach()
...
def loss(x):
    ...
    return crit(predict.log().detach(), torch.LongTensor([1]).clone().detach()).item()
plt.plot(np.arange(1, 100), [loss(x).data[0] for x in range(1, 100)])
